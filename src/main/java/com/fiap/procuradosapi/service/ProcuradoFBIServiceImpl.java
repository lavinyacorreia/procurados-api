...
import com.fiap.procuradosapi.repository.ProcuradoFBIRepository;


@Service
@Transactional
public class ProcuradoFBIServiceImpl implements ProcuradoFBIService{

	@Autowired
	public ProcuradoFBIRepository procuradoRepository;
